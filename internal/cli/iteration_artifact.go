...
var iterationArtifacts = map[string]iterationArtifact{
	...
	"task-tree":        {Name: "task-tree", File: "task-tree.json", Writable: true},
	"review-findings":  {Name: "review-findings", File: "review-findings.json"},
	"review-result":    {Name: "review-result", File: "review-result.json", Writable: true},
	"merge-result":     {Name: "merge-result", File: "merge-result.json", Writable: true},
